...
import static com.zzy.dicegames.ui.game.yahtzee.SixYahtzeeScoreBoardViewModel.*;
...
public class SixYahtzeeScoreBoardViewModelTest {
    ...
    private SixYahtzeeScoreBoardViewModel viewModel;

    @Before
    public void setUp() {
        viewModel = new SixYahtzeeScoreBoardViewModel();
    }
    ...
    public void testBonus() {
        for (int i = 6; i >= 2; i--) {
            viewModel.setDiceNumbers(i, i, i, i, i - 1, i - 1);
        ...
        viewModel.setDiceNumbers(1, 1, 1, 1, 2, 2);
    ...
    public void testJoker() {
        viewModel.setDiceNumbers(1, 2, 3, 5, 6, 6);
        viewModel.select(SIXES);
        viewModel.select(YAHTZEE);

        viewModel.setDiceNumbers(6, 6, 6, 6, 6, 6);
